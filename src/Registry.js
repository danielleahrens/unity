    ...
    return(
        <div className="Registry">
            ...
            <div className="registry-list-full">
                <p className="registry-list-header">We are still trying to fill out our house with some furniture. If you're in a place in your life where you're looking to downsize your possessions, we should talk! Here are some furniture things we're on the hunt for now:</p>
